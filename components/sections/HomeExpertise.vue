...
<template>
  <UiSectionContainerRow>
    <template #title>Our Expertise</template>
    <template #content>
      <UiSpotlight class="grid grid-cols-1 gap-8 sm:grid-cols-2 xl:grid-cols-4 group">
        <UiSpotlightCard>
          <div class="relative h-full bg-white dark:bg-gray-900 p-6 pb-8 rounded-[inherit] z-20 overflow-hidden">
            <!-- Radial gradient -->
            <div class="absolute bottom-0 w-1/2 -translate-x-1/2 translate-y-1/2 pointer-events-none left-1/2 -z-10 aspect-square" aria-hidden="true">
            ...
            <div class="flex flex-col items-center h-full text-center">
              ...
              <!-- Text -->
              <div class="mb-5 grow">
                <h2 class="mb-1 text-xl font-bold text-slate-200">Amazing Integration</h2>
              ...
              <a class="inline-flex justify-center items-center whitespace-nowrap rounded-lg bg-slate-800 hover:bg-slate-900 border border-slate-700 px-3 py-1.5 text-sm font-medium text-slate-300 focus-visible:outline-none focus-visible:ring focus-visible:ring-indigo-300 dark:focus-visible:ring-slate-600 transition-colors duration-150" href="#0">
                <svg class="mr-2 fill-slate-500" xmlns="http://www.w3.org/2000/svg" width="16" height="14">
